...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2023 at 06:29 PM
...
CREATE TABLE `products` (
  ...
  `product_doc` varchar(8000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `products` (`product_id`, `product_name`, `product_service`, `product_description`, `product_image`, `product_filter`, `product_doc`) VALUES
(1, 'Test11', 'Test1_service', 'Test1_desc', 'a', 'fdfd', 'https://drive.google.com/file/d/1zbgLw5woW3n1IPCQ-7aS4Z1SoCFbsLum/view?usp=sharing'),
