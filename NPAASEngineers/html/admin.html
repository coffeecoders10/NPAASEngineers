      ...
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-12 justify-content-center d-flex align-items-center mb-3">
            <h4 class="text-uppercase">Descripption Data</h4>
          </div>
          <div class="col-md-12 justify-content-center d-flex align-items-center mb-3">
            <textarea name="name" rows="8" cols="80"></textarea>
          </div>
          <div class="col-md-12 justify-content-center d-flex align-items-center mb-3">
            <button type="submit" name="button" class="admin-button">Submit</button>
          </div>
        </div>
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="form-row">
                <div class="col-md-6 form-group d-flex justify-content-center">
                  <button class="text-uppercase font-weight-bold" type="submit" style="width:100%">Add New</button>
                </div>
                <div class="col-md-6 form-group d-flex justify-content-center">
                  <button class="text-uppercase font-weight-bold" type="submit" style="width:100%">Edit</button>
                </div>
                <div class="col-md-10 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                  <div class="validate"></div>
                </div>
                <div class="col-md-2 form-group d-flex justify-content-center">
